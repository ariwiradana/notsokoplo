    ...
    >
      <Container className="md:px-8 px-4">
        {/* <div className="flex justify-center">
          <h2
            data-aos="fade-up"
            className="text-gray-900 flex items-center gap-x-2 text-xl py-2 px-4 md:text-3xl text-center font-montserrat uppercase"
          >
            Upcoming{" "}
        ...
        <div className="grid md:grid-cols-2 justify-center mt-8 md:mt-16 w-full gap-8 lg:max-w-[60vw] mx-auto">
          {gigs?.data?.map((gig) => (
            ...
            >
              <h3 className="text-sm font-montserrat bg-gray-900 px-2 py-1 text-white inline">
                {moment(gig?.date).format("D MMMM YYYY")}
              </h3>
              <h4 className="text-gray-900 font-semibold font-montserrat text-2xl mb-2 mt-4 line-clamp-1">
                {gig?.event}
              </h4>
